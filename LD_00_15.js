...
var LC  = ee.Image("users/jonathanreith/LD/LandCover15"),
    LPP = ee.Image("users/jonathanreith/LD/ProductivityPerformance15"), // 0ND/ 1D
    LPS = ee.Image("users/jonathanreith/LD/ProductivityState15"),      //0ND / 1 IMP / 2D
    LPT = ee.Image("users/jonathanreith/LD/ProductivityTrend15"),       //0ND / 1 IMP / 2D
    SOC = ee.Image("users/jonathanreith/SOC15")                 //1 nodata /2 deg / 3stable /4 imp
...
Export.image.toDrive({
  image: LD.clip(area),
  description: "LandDegradation2015",
  scale: 30,
  region: area,
